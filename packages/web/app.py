...
from psx_web.handlers import technical_analysis_handler, financial_analysis_handler, state_monitor
...
async def technical_analysis(request: TechnicalAnalysisRequest):
    ...
    """
    result = technical_analysis_handler.get_technical_analysis(request.symbol)
...
async def check_financial_analysis(request: FinancialAnalysisRequest):
    ...
    """
    result = financial_analysis_handler.check_latest_report(request.symbol)
    return result


@app.post("/api/financial-analysis/run")
async def run_financial_analysis(request: FinancialAnalysisRequest):
    """
    ...
    """
    result = financial_analysis_handler.run_financial_analysis(
        request.symbol,
